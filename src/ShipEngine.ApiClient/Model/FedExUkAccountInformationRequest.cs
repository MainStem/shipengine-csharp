...
{
    /// <summary>
    /// FedExUkAccountInformationRequest
    /// </summary>
    [DataContract]
    public partial class FedExUkAccountInformationRequest :  IEquatable<FedExUkAccountInformationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FedExUkAccountInformationRequest" /> class.
        /// </summary>
        ...
        public FedExUkAccountInformationRequest(string accountNumber = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string company = default(string), string countryCode = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), string phone = default(string), string postalCode = default(string), string stateProvince = default(string), string nickname = default(string), bool? agreeToEula = default(bool?), string meterNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FedExUkAccountInformationRequest {\n");
        ...
        {
            return this.Equals(input as FedExUkAccountInformationRequest);
        }

        /// <summary>
        /// Returns true if FedExUkAccountInformationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FedExUkAccountInformationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FedExUkAccountInformationRequest input)
        {
            if (input == null)
                return false;
