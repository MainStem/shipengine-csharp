...
namespace ShipEngine.ApiClient.Model
{
    ...
    public partial class AdvancedOptions :  IEquatable<AdvancedOptions>, IValidatableObject
    {
        ...
        public AdvancedOptions(string billToAccount = default(string), string billToCountryCode = default(string), BillToPartyEnum? billToParty = default(BillToPartyEnum?), string billToPostalCode = default(string), bool? containsAlcohol = default(bool?), bool? deliveredDutyPaid = default(bool?), bool? nonMachinable = default(bool?), bool? saturdayDelivery = default(bool?), bool? useUpsGroundFreightPricing = default(bool?), string freightClass = default(string), string customField1 = default(string), string customField2 = default(string), string customField3 = default(string))
        {
